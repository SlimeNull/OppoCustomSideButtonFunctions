...
首页的“振动与提示”用于设置动作触发后的反馈：“触发时振动”默认开启，使用 Android 预定义的短促触感；普通 Toast 默认关闭，内容可以修改。“未知摩斯电码序列提示”独立于普通 Toast，默认关闭。开启后，无效序列结束时会显示自定义文本（默认“未知操作序列”），并触发两次短促触感，中间间隔 50ms。
